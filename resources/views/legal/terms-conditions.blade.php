...
@php
	$titleExt = " | Terms & Conditons";
@endphp

@section('content')
<div class="container gbCard py-4 px-5 rounded">
	<div>
		<h2>Terms & Conditions Of Use</h2>
		<h4>Introduction</h4>
		<p>These terms and conditions apply between you, the User of this Website (including any sub-domains, unless expressly excluded by their own terms and conditions), and GioBase, the owner and operator of this Website. Please read these terms and conditions carefully, as they affect your legal rights. Your agreement to comply with and be bound by these terms and conditions is deemed to occur upon your first use of the Website. If you do not agree to be bound by these terms and conditions, you should stop using the Website immediately.</p>
		<p>In these terms and conditions, <strong>User</strong> or <strong>Users</strong> means any third party that accesses the Website and is not either (i) employed by  GioBase   and acting in the course of their employment or (ii) engaged as a consultant or otherwise providing services to  GioBase   and accessing the Website in connection with the provision of such services.</p>
	...
	<div>
		...
		<ol>
			...
			<li>You must not otherwise reproduce, modify, copy, distribute or use for commercial purposes any Content without the written permission of  GioBase . </li>
			...
			<li>You represent and warrant that you own or otherwise control all the rights to the Content you post; that the Content is accurate; that use of the Content you supply does not violate any provision of these terms and conditions and will not cause injury to any person; and that you will indemnify  GioBase   for all claims resulting from Content you supply.</li>
		</ol>
	</div>
	...
	<div>
		...
		<ol>
			<li>This Website may contain links to other sites. Unless expressly stated, these sites are not under the control of GioBase or that of our affiliates.</li>
	...
	<div>
		...
		<ol>
			<li>Use of the Website is also governed by our Privacy Policy (which includes our Cookie Policy), which are incorporated into these terms and conditions by this reference. To view the Privacy Policy (& Cookie Policy), please click on the following: <a href="/privacy-policy">https://www.giobase.net/privacy-policy</a>.</li>
		</ol>
	</div>
	...
	<div>
		...
		<ol>
			<li>Any online facilities, tools, services or information that  GioBase   makes available through the Website (the <strong>Service</strong>) is provided "as is" and on an "as available" basis. We give no warranty that the Service will be free of defects and/or faults. To the maximum extent permitted by the law, we provide no warranties (express or implied) of fitness for a particular purpose, accuracy of information, compatibility and satisfactory quality.  GioBase   is under no obligation to update information on the Website.</li>
			<li>Whilst GioBase uses reasonable endeavours to ensure that the Website is secure and free of errors, viruses and other malware, we give no warranty or guaranty in that regard and all Users take responsibility for their own security, that of their personal details and their computers.</li>
			<li>GioBase accepts no liability for any disruption or non-availability of the Website.</li>
			<li>GioBase reserves the right to alter, suspend or discontinue any part (or the whole of) the Website including, but not limited to, any products and/or services available. These terms and conditions shall continue to apply to any modified version of the Website unless it is expressly stated otherwise.</li>
		</ol>
	</div>
	...
	<div>
		...
		<ol>
			...
			<li>To the maximum extent permitted by law,  GioBase   accepts no liability for any of the following:
				<ol class="lower-roman py-2">
	...
	<div>
		<h4>GioBase details</h4>
		<ol>
			<li>GioBase is a privatly run operation, operated by its owner through the Website <a href="/">https://www.giobase.net</a>. You can contact GioBase by email on <a href="mailto:gb-enquires@giobase.net">gb-enquires@giobase.net</a>.</p>
			</li>
		</ol>
	</div>
	...
	<div>
		<h4>Attribution</h4>
		<ol>
			<li>These terms and conditions were created using a document from <a href="https://www.rocketlawyer.com/gb/en/" target="_blank" rel="noopener noreferrer">Rocket Lawyer at https://www.rocketlawyer.com/gb/en/</a> on <strong>01 May 2020</strong>.</p>
			</li>
		</ol>
	</div>
</div>
